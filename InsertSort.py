...
def InsertSort(A):   #Функция сортировки вставками insert
    for i in range(1, N):
        t = A[i]
        j=i
...
table = prettytable.PrettyTable(["Размер списка", "Время интсерт", "Время быстрой"])
x = []
y1 = []
y2 = []
...
for N in range(1000, 5001, 1000):
    ...
    print("isort   " + str(N) + "   заняла   " + str((t2 - t1).total_seconds()) + "c")
